...
import 'package:netease_cloud_music/pages/comment/comment_input_widget.dart';
          ...
          Align(
            child: CommentInputWidget((content) {
              ...
              NetUtils.sendComment(
                ...
                Utils.showToatst('评论成功！');
                setState(() {
                  commentData.insert(
                      commentData.map((c) => c.title).toList().indexOf('最新评论') +
                          1,
                      r.comment);
                });
              });
